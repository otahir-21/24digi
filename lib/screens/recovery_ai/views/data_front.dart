...
import 'package:kivi_24/screens/recovery_ai/views/data_back.dart';
...
class DataFront extends StatelessWidget {
  DataFront({super.key});

  final controller = Get.put(DataFrontController());
                  ...
                  Expanded(
                    child: ListView(
                      children: [
                        ...
                        SizedBox(height: 45 * s),
                        Image.asset("assets/images/front_body.png"),
                        Text(
                          "When did it start?",
                          style: TextStyle(
                            fontFamily: "HelveticaNeue",
