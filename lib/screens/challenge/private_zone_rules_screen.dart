...
class PrivateZoneRulesScreen extends StatelessWidget {
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Icon(Icons.lock_rounded, size: 14 * s, color: Colors.orangeAccent),
                SizedBox(width: 4 * s),
                Text(
                  'Locked',
  ...
  Widget _buildRoomEntryFeeSection(
    double s,
    Color cardDark,
    Color themeGreen,
  ) {
  ...
  Widget _buildAgreeAndJoinButton(BuildContext context, double s, Color themeGreen) {
    return SizedBox(
      width: double.infinity,
      height: 52 * s,
