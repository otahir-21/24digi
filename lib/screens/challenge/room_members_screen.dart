...
class _RoomMembersScreenState extends State<RoomMembersScreen> {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ..._admins.asMap().entries.map((e) => _buildAdminRow(s, e.key, e.value.$1, e.value.$2, e.value.$3, e.value.$4)),
                    SizedBox(height: 24 * s),
                    _buildMembersHeader(s),
                    SizedBox(height: 12 * s),
                    ..._members.asMap().entries.map((e) => _buildMemberRow(s, e.key, e.value.$1, e.value.$2, e.value.$3)),
                    SizedBox(height: 24 * s),
                    Center(
                      child: Text(
  ...
  Widget _buildAdminRow(double s, int index, String name, String level, String cls, String tag) {
    return Padding(
  ...
  Widget _buildMemberRow(double s, int index, String name, String level, String cls) {
