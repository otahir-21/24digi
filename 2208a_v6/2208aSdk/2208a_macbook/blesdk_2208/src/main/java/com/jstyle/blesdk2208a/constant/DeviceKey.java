...
public class DeviceKey {
    ...
    public static final String KHrvTempValue = "KHrvTempValue";
    ...
    public static final String KSportswitch = "sportSwitch";
 ...
 */
    ...
    public static final String minDiastolicBP = "minDiastolicBP";
    public static final String maxDiastolicBP = "maxDiastolicBP";
    public static final String minSystolicBP = "minSystolicBP";
    public static final String maxSystolicBP = "maxSystolicBP";
}
