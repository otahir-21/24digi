...
public class PieChartData extends AbstractChartData {
	...
	private int centerText3Color = Color.BLACK;
	private int centerText3FontSize = DEFAULT_CENTER_TEXT2_SIZE_SP;
	private Typeface centerText3Typeface;
	...
	public int getCenterText3Color() {
		return centerText3Color;
	}

	public void setCenterText3Color(int centerText3Color) {
		this.centerText3Color = centerText3Color;
	}

	public int getCenterText3FontSize() {
		return centerText3FontSize;
	}

	public void setCenterText3FontSize(int centerText3FontSize) {
		this.centerText3FontSize = centerText3FontSize;
	}

	public Typeface getCenterText3Typeface() {
		return centerText3Typeface;
	}

	public void setCenterText3Typeface(Typeface centerText3Typeface) {
		this.centerText3Typeface = centerText3Typeface;
	}

	public String getCenterText3() {
		return centerText3;
	}
